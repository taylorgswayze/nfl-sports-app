...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-)wukqz60oq)l+92hqf*6i%%wlm0khjp&)62g07cxb@=h*zi=')
...
MIDDLEWARE = [
    ...
    'nfl.usage.ActiveUserMiddleware',
]
